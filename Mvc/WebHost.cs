...
{
    public static async Task StartAsync(int port, IMvcApplication application)
    {
        IList<Route> routeTable = new List<Route>();

        IServiceCollection serviceCollection = new ServiceCollection();
        serviceCollection.Add<ILogger, FileLogger>();
        ...
        // logger.Log("Requests:");
        var httpServer = new HttpServer(port, routeTable, logger);
